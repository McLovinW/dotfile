...
const baseColors = Object.freeze({
  red: {gui: '#E53A3A', cterm: '204', cterm16: '1'}, // alternate cterm: 168
  dark_red: {gui: '#be5046', cterm: '196', cterm16: '9'},
  green: {gui: '#01A252', cterm: '114', cterm16: '2'},
  yellow: {gui: '#D6CB20', cterm: '180', cterm16: '3'},
  dark_yellow: {gui: '#D19A66', cterm: '173', cterm16: '11'},
  blue: {gui: '#01A0E4', cterm: '39', cterm16: '4'}, // alternate cterm: 75
  purple: {gui: '#FF00FF', cterm: '170', cterm16: '5'}, // alternate cterm: 176
...
try {
  ...
  try {
    writeFileSync(
      resolve(__dirname, '../term/One Dark.alacritty'),
      alacrittyTemplate(terminalPalette)
    );
    writeFileSync(
